...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_fsw9qkq', 'template_gd6hhfi', formRef.current, {
            publicKey: 'oKYOhADhAn6UZ-GSV',
          })
          .then(
            () => {
              setSuccess(true);
    ...
    <motion.div className="contact" variants={variants} initial="initial" whileInView="animate">
        <motion.div className="textContainer" variants={variants}>
            ...
            <motion.div className="item" variants={variants}>
                <h2>Mail</h2>
                <span>sapkota.arjan12@gmail.com</span>
            </motion.div>
            <motion.div className="item" variants={variants}>
                <h2>Address</h2>
                <span>Dhungedhara, KMC-16, Nepal</span>
            </motion.div>
            <motion.div className="item" variants={variants}>
                <h2>Phone</h2>
                <span>+977-9869320255</span>
            </motion.div>
        </motion.div>
